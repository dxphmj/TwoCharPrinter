...
{
	CBrush cbrushB(QColor(0,0,0));//��ˢ
	cbrushB.setStyle(Qt::SolidPattern);
	CBrush cbrushG(Qt::darkGreen);//��ˢ
	cbrushB.setStyle(Qt::SolidPattern);
	CPen cpenTrans(Qt::transparent);//͸����
