...
public://方法
	...
	//vector<vector<bool> > m_dots;//鍏朵腑dots鐨勮鍜屽垪鐨勫ぇ灏忓氨鏄瓧绗︿覆鐨勫鍖呭洿鐩?
	//void GetVectorWordDots();
	//void ReadOneVectorWord(FILE *pFile,char* strText,vector<vector<bool> >& dots,int& nWidth);//鍏朵腑dots鐨勮鍜屽垪鐨勫ぇ灏忓氨鏄瓧绗︿覆鐨勫鍖呭洿鐩?
