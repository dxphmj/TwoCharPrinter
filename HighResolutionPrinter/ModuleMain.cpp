...
//	staSysRea = (GETnBIT_from_bytStatus(0, 0, 1)==_T("1"));  //系统准备好
	...
	staPriHeaCle = (GETnBIT_from_bytStatus(3, 7, 1)==“1”?true:false) ;  //'开关机清洗
	...
	staSolLevFau = theApp.myclassMessage.to_String(GETnBIT_from_bytStatus(4, 5, 1)==“1”?true:false) +theApp.myclassMessage.to_String(GETnBIT_from_bytStatus(4, 4, 1)==“1”?true:false);  //'溶剂液位状态
	staInkLevFau = theApp.myclassMessage.to_String(GETnBIT_from_bytStatus(4, 7, 1)==“1”?true:false) + theApp.myclassMessage.to_String(GETnBIT_from_bytStatus(4, 6, 1)==“1”?true:false);  //'墨水液位状态
...
QString GETnBIT_from_bytReadData(int I , int m , int n )
{
	string tempCstr="";
	...
	QString cstringStr= tempstringToLPCWSTR.stringToLPCWSTR(tempCstr);
