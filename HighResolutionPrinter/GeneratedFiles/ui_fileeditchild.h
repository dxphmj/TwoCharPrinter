...
public:
    ...
    QComboBox *fontTypeComBox;
    QComboBox *fontSizeComBox;
    QPushButton *variableBut;
    QWidget *tab_3;
    QWidget *tab_4;
    QWidget *tab_5;
    QWidget *tab_6;
...
"QTabBar::tab{height:50}"));
        ...
        degreeRedBut->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        degreeAddBut->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        internalAddBut->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        internalRedBut->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        fontTypeComBox = new QComboBox(tab);
        fontTypeComBox->setObjectName(QStringLiteral("fontTypeComBox"));
        fontTypeComBox->setGeometry(QRect(540, 145, 181, 31));
        fontTypeComBox->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        fontSizeComBox = new QComboBox(tab);
        fontSizeComBox->setObjectName(QStringLiteral("fontSizeComBox"));
        fontSizeComBox->setGeometry(QRect(540, 245, 181, 31));
        fontSizeComBox->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        variableBut = new QPushButton(tab);
        variableBut->setObjectName(QStringLiteral("variableBut"));
        variableBut->setGeometry(QRect(540, 330, 181, 41));
        variableBut->setFont(font);
        variableBut->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QWidget *FileEditChild)
    {
        ...
        fontTypeLab->setText(QApplication::translate("FileEditChild", "<html><head/><body><p><span style=\" color:#ffffff;\">\345\255\227\344\275\223</span></p></body></html>", 0));
        degreeShowLab->setText(QApplication::translate("FileEditChild", "<html><head/><body><p><span style=\" color:#ffffff;\">0</span></p></body></html>", 0));
        rotateLab->setText(QApplication::translate("FileEditChild", "<html><head/><body><p><span style=\" color:#ffffff;\">\346\227\213\350\275\254</span></p></body></html>", 0));
        degreeAddBut->setText(QApplication::translate("FileEditChild", "\357\274\213", 0));
        fontSizeLab->setText(QApplication::translate("FileEditChild", "<html><head/><body><p><span style=\" color:#ffffff;\">\345\255\227\345\217\267</span></p></body></html>", 0));
        internalLab->setText(QApplication::translate("FileEditChild", "<html><head/><body><p><span style=\" color:#ffffff;\">\351\227\264\350\267\235</span></p></body></html>", 0));
        ...
        currentValShow1Lab_2->setText(QApplication::translate("FileEditChild", "<html><head/><body><p><span style=\" color:#ffffff;\">0</span></p></body></html>", 0));
        variableBut->setText(QApplication::translate("FileEditChild", "\345\217\257\345\217\230", 0));
